...
@section('content')
  ...
  <a href="tournaments-single.html#" class="scrollToTop"><i class="fas fa-angle-double-up"></i></a>
  ...
  <section id="banner-section" class="inner-banner tournaments">
      <div class="ani-img">
          <img class="img-1" src="{{ asset('images/banner-circle-1.png')}}" alt="icon">
          <img class="img-2" src="{{ asset('images/banner-circle-2.png')}}" alt="icon">
          <img class="img-3" src="{{ asset('images/banner-circle-2.png')}}" alt="icon">
      </div>
              ...
              <div class="top-area">
                  <div class="row">
                      <div class="col-lg-4 col-md-4 col-sm-4 d-flex justify-content-center">
                          <img src="{{asset('images/character_01.png')}}" alt="image">
                      </div>
                      <div class="col-lg-4 col-md-4 col-sm-4 d-flex align-items-center justify-content-sm justify-content-center">
                          <div class="mid-area text-center">
                              <img src="{{asset('images/text-img.png')}}" alt="image">
                              <h5>Fortnite Weekly Nano</h5>
                          </div>
                      </div>
                      <div class="col-lg-4 col-md-4 col-sm-4 zindex">
                          <img src="{{asset('images/character_02.png')}}" alt="image">
                      </div>
                  </div>
              </div>
                  ...
                  <div class="bottom">
                      <div class="row d-flex justify-content-between">
                          ...
                          <div class="col-lg-3 col-md-4 text-center">
                              <h2 class="dollar">{{ $tournament->prize }}</h2>
                  ...
                  <div class="row justify-content-center">
                      <div class="col-lg-8">
                          ...
                          <div class="row wrapper">
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                  <div class="single-area">
                                      <img src="{{asset('images/format-icon-1.png')}}" alt="image">
                                      <h6>Game</h6>
                                      <p class="text-sm">{{ $tournament->game }}</p>
                                  </div>
                              </div>
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                  <div class="single-area">
                                      <img src="{{ asset('images/format-icon-2.png')}}" alt="image">
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                  <div class="single-area">
                                      <img src="{{asset('images/format-icon-3.png')}}" alt="image">
                                      <h6>Team Size</h6>
                                      <p class="text-sm">{{ $tournament->size }}</p>
                                  </div>
                              </div>
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                  <div class="single-area">
                                      <img src="{{asset('images/format-icon-4.png')}}" alt="image">
                                      <h6>Entry Fee</h6>
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                  <div class="single-area">
                                      <img src="{{asset('images/format-icon-5.png')}}" alt="image">
                                      <h6>Prize Pool</h6>
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-6">
                                  <div class="single-area">
                                      <img src="{{asset('images/format-icon-6.png')}}" alt="image">
                          ...
                          <div class="magnific-area">
                              <img src="{{ asset('Tournament/'.$tournament->image) }}" alt="image">
                              <a href="" class="mfp-iframe popupvideo">
                                  <img src="{{asset('images/play-icon-2.png')}}" alt="image">
                              </a>
                          </div>
                      </div>
                          ...
                          <div class="sidebar">
                              <div class="single-side">
                                  ...
                                  <div class="participants">
                                      <ul>
                                          <li><span>Registered</span><span>{{ $tournament->users()->count() }}</span></li>
                                          <li><span>Confirmed</span><span>{{ $tournament->users()->count() }}</span></li>
                              ...
                              <div class="single-side">
                                  <div class="part-people d-flex align-items-center justify-content-between">
                                      <ul class="d-flex">
                                          <li><a href="tournaments-single.html#"><img src="images/participants-1.png" alt="images"></a></li>
                                          <li><a href="tournaments-single.html#"><img src="images/participants-2.png" alt="images"></a></li>
                                          <li><a href="tournaments-single.html#"><img src="images/participants-3.png" alt="images"></a></li>
                              ...
                              <div class="single-side">
                                  <div class="head-area d-flex justify-content-between align-items-center">
                                      <h5>Results</h5>
                                      <a href="tournaments-single.html#" class="viewall text-sm">View all</a>
                                  </div>
                                  <div class="result-single">
                                      <img src="{{asset('images/result-img-1.png')}}" alt="images">
                                  ...
                                  <div class="result-single">
                                      <img src="{{asset('images/result-img-2.png')}}" alt="images">
                                      <div class="text-area d-flex justify-content-between align-items-center">
                                          <span>2nd</span>
                                          <h4>$25.0</h4>
                                      </div>
                                  ...
                                  <div class="result-single">
                                      <img src="{{asset('images/result-img-3.png')}}" alt="images">
                                      <div class="text-area d-flex justify-content-between align-items-center">
                                          <span>3rd</span>
                                          <h4>$15.0</h4>
                                      </div>
                              ...
                              {{-- <div class="single-side">
                                  ...
                                  <div class="game-area d-flex align-items-center">
                                      <img src="{{ asset('Tournament/'.$tournament->image) }}" alt="images">
